#!/usr/bin/env sh
# IDS Admin Demo Script
# Purpose: boot Admin locally and exercise core endpoints with sample config upload.
# Fit: quick confidence check for upload/list/read API flow.
